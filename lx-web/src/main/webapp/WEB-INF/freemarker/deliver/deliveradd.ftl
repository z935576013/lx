...
<div class="main mt">
	<form method="post" id="addFrom"  action="${base}/deliver/save.do">
	<input type="hidden" value="${item.id!}" name="needOrderItemId">
	<div class="tips"><a href="#">发货单详情</a><span>》</span><span>新增发货记录</span></div>
	<div class="search mtop">
    	<h5><p class="tit">新增发货记录</p><p>输入以下数据，全部完成后点击上传</p></h5>
        <a onclick="$('#addFrom').submit();"  class="dc">保存</a>
        <a <#if success ??>onclick="location='${base}/need/needlist.do'"<#else>onclick="history.back();"</#if> class="qx">取消</a>
    </div>
			...
			<dd class="accordion-content accordionItem is-expanded" id="accordion2" aria-hidden="true">
				...
				<div class="s_main3">
                    <div class="jg">
                        ...
                        <dl class="s_d sd5">
                            <dt>批号</dt>
                            <dd>${deliver.batchNum!}</dd>
                        </dl>
                         <dl class="s_d sd5">
                            <dt>编码</dt>
                            <dd>${deliver.productCode!}</dd>
                        </dl>
                         <dl class="s_d sd5">
                            <dt>规格</dt>
                            <dd>${deliver.spec!}</dd>
                   ...
                   <div class="jg">
					...
					<#if deliver.smsNeed ==1 >
                  	<div class="jg">
					<span>短信通知联系人：</span><em>${deliver.smsName!}</em><b>${deliver.smsMobile!}</b>
                	</div>
					</#if>
					</#if>
				</div>
			...
			<dd class="accordion-content accordionItem is-expanded" id="accordion3" aria-hidden="true">
                <div class="s_main3">
                    ...
                    <div class="jg">
                        <dl class="s_d sd5">
                            <dt>发货日期</dt>
                            <dd><input type="text2" value="" class="text6 dateSelect" name="deliverDate" /></dd>
                        </dl>
                        <dl class="s_d sd5">
                            <dt>批号</dt>
                            <dd><input type="text2" value="" class="text5" name="batchNum"  /></dd>
                        </dl>
                         <dl class="s_d sd5">
                            <dt>编码</dt>
                            <dd><input type="text2" value="" class="text5" name="productCode" /></dd>
                        </dl>
                         <dl class="s_d sd5">
                            <dt>规格</dt>
                         ...
                         <dl class="s_d sd5">
                            <dt>发往地</dt>
                            <dd><input type="text2" value="" class="text5" name="deliverCity" /></dd>
                        </dl>
                    </div>
                   ...
                   <div class="jg">
                    <dl class="s_d sd6">
                            <dt>备注</dt>
                            <dd><input type="text2" value="" class="text5" name="note" /></dd>
                    </dl>
					<dl class="s_d sd6">
                            <dt>物流编号</dt>
                            <dd><input type="text2" value="" class="text5" name="logisticsCode" /></dd>
                    </dl>
                    </div>
                  <div class="jg"><span><input type="checkbox" name="smsNeed" value="1" /></span><span>短信通知联系人：</span></div>
				  <dl class="s_d sd5">
                            <dd>姓名<input type="text2" value="" class="text5" name="smsName" />
                            电话<input type="text2" value="" class="text5" name="smsMobile" /></dd>
                   </dl>
                </div>
			</dd>
            </dl>
